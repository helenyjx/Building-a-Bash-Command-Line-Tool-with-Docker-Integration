...
* Updating the record after excluding the header line from the output: `docker run -it 4ef3bb211c45 /bin/bash sort.sh Walmart.csv`
...
* Clean the data from stores 1 to 45, to show each record in orginized format: `docker run -it 4ef3bb211c45 /bin/bash clean.sh Walmart.csv`
...
<img width="953" alt="envir" src="https://user-images.githubusercontent.com/112274822/193358114-59949a1e-7bc8-4197-9ab3-47eb2f158e31.png">
...
#### Create a new repositpry in ECR:
...
Type code: `aws ecr get-login-password --region us-east-2 | docker login --username AWS --password-stdin 894437926398.dkr.ecr.us-east-2.amazonaws.com`
